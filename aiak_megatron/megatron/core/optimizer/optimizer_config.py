...
class OptimizerConfig:
    ...
    ################
    # Optimizer Offload (aiak added)
    ################
    # offload optimizer between pp stages
    d2d_optimizer: str = 'disabled'
    overlap_d2d_optimizer: bool = False
    d2d_max_data_volume: int = 0
    reduced_data_volume_from_pre_stage: int = 0
